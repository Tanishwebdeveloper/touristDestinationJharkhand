...
//   // State & handlers at top of component:
//   const [orders, setOrders] = useState([]);
//   const [loadingOrders, setLoadingOrders] = useState(false);
//   const [editingOrder, setEditingOrder] = useState(null);
//   const [orderFormData, setOrderFormData] = useState({
//     order_id: "", location: "", description: ""
//   });

//   // Fetch orders when section active
//   useEffect(() => {
...
//   // Delete order
//   const handleOrderDeleteClick = async (orderId) => {
...
//         {["user-management", "approvals", "destinations", "guides", "drivers", "products", "orders", "reports"].map(
//           (item) => (
//             <button
//               key={item}
...
//                 <h3 className="font-bold mb-2 text-lg">Edit Order #{editingOrder.order_id.slice(-6)}</h3>
//                 <form onSubmit={handleOrderUpdateSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                   <input
//                     name="order_id"
...
//               <p>Loading orders...</p>
//             ) : (
//               <table className="min-w-full bg-white border max-w-6xl">
//                 <thead>
//                   <tr>
...
//                       <td className="border px-4 py-2">{order.order_id.slice(-8)}</td>
//                       <td className="border px-4 py-2">
//                         {order.user?.FirstName} {order.user?.LastName}
//                       </td>
//                       <td className="border px-4 py-2">{order.location}</td>
//                       <td className="border px-4 py-2">
//                         {order.resort && <span className="bg-blue-100 px-2 py-1 rounded text-xs mr-1">Resort</span>}
//                         {order.guide && <span className="bg-green-100 px-2 py-1 rounded text-xs mr-1">Guide</span>}
//                         {order.driver && <span className="bg-yellow-100 px-2 py-1 rounded text-xs mr-1">Driver</span>}
//                         {order.product && <span className="bg-purple-100 px-2 py-1 rounded text-xs mr-1">Product</span>}
//                       </td>
...
//                         </button>
//                         <button
//                           onClick={() => handleOrderDeleteClick(order._id)}
//                           className="text-red-600 hover:text-red-800"
//                           title="Delete"
//                         >
//                           <FaCircleXmark />
